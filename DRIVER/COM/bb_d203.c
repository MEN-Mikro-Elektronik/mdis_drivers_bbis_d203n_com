...
#include <MEN/mdis_version.h>	/* id prom functions			*/
 ...
 *
 *					PCI_DEVICE_ID overwrites PCI_BUS_SLOT.
 *					PCI_DEVICE_ID The device id can set	directly.
 *
 *---------------------------------------------------------------------------
 ...
 *	Globals....:	---
 ****************************************************************************/
static int32 D203_Exit( BBIS_HANDLE	 **brdHdlP )
{
 ...
 *					*pciBusNbrP		mainPCI bus number of D203
 *	Globals....: -
 ****************************************************************************/
